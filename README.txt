...
5. Открыть src/test/java/resources/yevheniia_Starukh.feature и запустить Feature: Test some features of site  (нажав на зеленый треугольник напротив нее)
6. Ждать пока пройдут все тесты и просмотреть результат (во вкладке Run внизу экрана)
